    ...
    <div>
        ...
        <div className='view-demo-option'>
            ...
            <Link to='/viewdemo/nft' style={{textDecoration:'none'}}>
                <div className='option-head'>Link2</div>
                <div className='option-head-line-nft'></div>
            </Link>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum est itaque eveniet, <br /> aliquam maiores totam corrupti praesentium laboriosam similique</p>
            
            <p>Lorem ipsum dolor sit amet consectetur,<font color='aqua'>adipisicing elit.</font> Eveniet fuga accusamus <br /> in exercitationem. Libero,</p>
