    ...
    <div>
        ...
        <div className='view-demo-option'>
            ...
            <Link to='/viewdemo' style={{textDecoration:'none'}}>
                <div style={{color:'white'}}>Link1</div>
            </Link>
            ...
            <Link to='/viewdemo/slots' style={{textDecoration:'none'}}>
                <div className='option-head'>Link5</div>
                <div className='option-head-line-slot'></div>
            </Link>
            </div>
            <hr className='view-demo-line' /> <br />
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis, magni velit nam <br /> soluta accusantium necessitatibus, dignissimos mollitia ducimus deserunt ex explicabo,<br /> <font color='aqua'>culpa ad exercitationem similique</font> </p>
